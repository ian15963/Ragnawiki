...
INSERT INTO bonus(Forca, Agilidade, Vitalidade, Inteligencia, Destreza, Sorte) VALUES (0,0,0,0,0,0),(0,7,5,7,10,5),(7,2,4,0,3,2),(0,4,0,8,3,3),(4,4,2,1,4,3),(5,1,4,5,1,2),(3,2,3,3,3,4),(3,3,1,2,7,2),(8,2,10,0,6,4),
(7,2,7,6,3,6),(1,8,1,12,6,2),(5,5,3,9,5,3),(6,10,2,4,8,0),(6,7,6,4,7,0),(6,2,6,2,12,2),(5,6,3,7,9,0),(8,7,6,2,4,3),(5,4,5,5,4,7),(4,6,2,4,10,4),(2,7,3,5,9,4),
(2,7,3,5,5,8),(15,8,8,2,9,3),(9,8,10,7,8,3),(3,8,5,17,9,3),(6,9,4,13,11,2),(9,15,3,0,10,8),(9,11,4,3,12,6),(6,7,6,6,12,8),(4,6,3,7,14,11),(9,9,7,7,10,3),
(7,8,7,12,9,2),(4,11,3,5,14,8),(8,12,2,5,14,4),(6,14,2,5,16,2),(5,5,7,10,8,5),(8,3,8,10,8,3),(1,7,7,14,8,3),(4,4,7,12,9,4),(8,10,6,5,8,3),(8,7,8,6,5,6),
(9,5,9,6,5,6),(4,6,7,12,8,3),(9,9,6,7,8,1),(6,6,7,11,7,3),(6,6,7,11,7,3),(2,11,7,9,8,3),(7,6,7,9,9,2),(5,9,7,9,8,2),(6,6,0,0,6,6),(1,8,1,5,6,4),(4,1,1,2,9,7),
(5,5,5,5,5,5),(12,12,0,0,6,0),(0,0,6,12,12,0),(10,8,4,3,9,3),(3,7,5,11,11,0),(7,6,4,6,8,4),(7,6,4,6,8,4),(3,6,6,8,8,5);

INSERT INTO classe(nome, tipo, descricao, classeAnterior, fkBonus) VALUES ('Aprendizes', 'Classe Inicial', 'Aprendizes não possuem nenhum tipo de especialidade, além da determinação de se tornarem melhores e mais fortes.
...
Ou, se preferir, alcance o nível de base 45 para aventurar-se como os superaprendizes.', null, 1), 
...
Os Invocadores só podem alcançar até 125 de atributos.', null, 2), 
...
Ao atingirem o nível de classe 40, podem evoluir para Cavaleiros ou Templários.', 1, 3),
...
Ao atingirem o nível de classe 40, podem evoluir para Bruxos ou Sábios.', 1, 4), 
...
Ao atingirem o nível de classe 40, podem evoluir para Mercenários ou Arruaceiros.', 1, 5),
...
Ao atingirem o nível de classe 40, podem evoluir para Ferreiros ou Alquimistas.', 1, 6),
...
Ao atingirem o nível de classe 40, podem evoluir para Sacerdotes ou Monges.', 1, 7),
...
Ao atingirem o nível de classe 40, podem evoluir para Caçadores. Também podem virar Bardos se forem homens e Odaliscas se forem mulheres.', 1, 8), 
...
Ao atingirem o nível de base 99, podem transcender para Lordes ou evoluírem para Cavaleiros Rúnicos.', 3, 9),
...
Ao atingirem o nível de base 99, podem transcender para Paladinos ou evoluírem para Guardiões Reais.', 3, 10), 
...
Ao atingirem o nível de base 99, podem transcender para Arquimagos ou evoluírem para Arcanos.', 4, 11),
...
Ao atingirem o nível de base 99, podem transcender para Professores ou evoluírem para Feiticeiros.', 4, 12), 
...
Ao atingirem o nível de base 99, podem transcender para Algozes ou evoluírem para Sicários.',5, 13),
...
Ao atingirem o nível de base 99, podem transcender para Desordeiros ou evoluírem para Renegados.',5, 14), 
...
Ao atingirem o nível de base 99, podem transcender para Mestres-Ferreiros ou evoluírem para Mecânicos.', 6, 15), 
...
Ao atingirem o nível de base 99, podem transcender para Criadores ou evoluírem para Bioquímicos.', 6, 16),
...
Ao atingirem o nível de base 99, podem transcender para Mestres ou evoluírem para Shuras.', 7, 17),
...
Ao atingirem o nível de base 99, podem transcender para Sumo Sacerdotes ou evoluírem para Arcebispos.', 7, 18), 
...
Ao atingirem o nível de base 99, podem transcender para Atiradores de Elite ou evoluírem para Sentinelas.', 8, 19), 
...
Ao atingirem o nível de base 99, podem transcender para Menestréis ou evoluírem para Trovadores.',8, 20), 
...
Ao atingirem o nível de base 99, podem transcender para Ciganas ou evoluírem para Musas.',8, 21), 
...
Ao atingirem os níveis 99 de base e 60 de classe, podem evoluir para Cavaleiros Rúnicos.',9, 22)
...
Ao atingirem os níveis 99 de base e 60 de classe, podem evoluir para Guardiões Reais.', 10, 23),
...
Ao atingirem os níveis 99 de base e 60 de classe, podem evoluir para Arcanos.', 11, 24), 
...
Ao atingirem os níveis 99 de base e 60 de classe, podem evoluir para Feiticeiros.', 12, 25), 
...
Ao atingirem os níveis 99 de base e 60 de classe, podem evoluir para Sicários.', 13, 26), 
...
Ao atingirem os níveis 99 de base e 60 de classe, podem evoluir para Renegados.', 14, 27), 
...
Ao atingirem os níveis 99 de base e 60 de classe, podem evoluir para Mecânicos.', 15, 28),
...
Ao atingirem os níveis 99 de base e 60 de classe, podem evoluir para Bioquímicos.', 16, 29), 
...
Ao atingirem os níveis 99 de base e 60 de classe, podem evoluir para Shuras.', 17, 30), 
...
Ao atingirem os níveis 99 de base e 60 de classe, podem evoluir para Arcebispos.', 18, 31), 
...
Ao atingirem os níveis 99 de base e 60 de classe, podem evoluir para Sentinelas.', 19, 32),
...
Ao atingirem os níveis 99 de base e 60 de classe, podem evoluir para Trovadores.', 20, 33), 
...
Ao atingirem os níveis 99 de base e 60 de classe, podem evoluir para Musas.', 21, 34),
...
As runas são um triunfo à parte, diante de tantas opções que a classe pode oferecer.', 22,35), 
...
Una-se a outros Guardiões Reais para aumentar seus poderes, e monte em um forte e imponente Grifo!', 23, 36), 
...
Obtenha controle das caóticas forças da magia e descubra novas formas de causar dano e condições anormais em seus inimigos!', 24, 37),
...
Aprenda novas formas de ataque, controlando poderosas energias místicas!', 25, 38), 
...
Domine ataques especiais capazes de atingir todos ao seu redor ou inimigos mais distantes.', 26, 39), 
...
Domine truques e furtividade para escapar de qualquer enrascada.', 27, 40), 
...
Mecanismo Especial de Combate com Habilidade Arcana.', 28, 41), 
...
Crie novos tipos de poções, sementes e materiais químicos!', 29, 42), 
...
Treine corpo e mente e domine seu ki para que seus poderes físicos ultrapassem os limites humanos e assim torne-se um novo tipo de campeão divino!', 30, 43), 
...
Domine os mais fortes poderes divinos e torne-se capaz de exorcizar o mal do mundo!', 31, 44),
...
Domine e monte Worgs, os bestiais lobos de guerra, criados para atacar os inimigos ao lado de seu mestre.', 32, 45), 
...
Forme uma dupla e libere todo o potencial da sua música!', 33, 46), 
...
Forme uma dupla e libere todo o potencial da sua arte!', 34, 47), 
...
Ao atingirem o nível de classe 40, podem evoluir para Mestres Taekwons ou Espiritualistas.', 1, 48), 
...
Ao atingirem o nível de base 99, homens podem evoluir para Kagerou e mulheres, para Oboro.', 1, 49), 
...
Ao atingirem o nível de base 99 e classe 50, podem evoluir para Insurgentes.', 1, 50),
...
Ao atingirem o nível de base 99, podem expandir a classe para ganhar novas habilidades e seguir evoluindo.', 1,51), 
...
Ao atingirem o nível de base 99 e classe 50, podem evoluir para Mestres Estelares.', 48, 52), 
...
Ao atingirem o nível de base 99 e classe 50, podem evoluir para Ceifadores de Almas.', 48, 53), 
...
Assim, o Grão-Mestre poderá repassar suas descobertas para os Mestres Taekwons interessados nos poderes universais.', 52, 54),
...
Então, ela passou anos esperando que os Espiritualistas demonstrassem interesse em se tornar alguém como ela.', 53, 55), 
...
Com habilidades para encarar uma guerra, os Kagerous se destacam por 3 especialidades: ajudar seus aliados, atrapalhar os inimigos e remover a capacidade de reflexão.', 49, 56), 
...
Especializam-se em fazer com que habilidades de cura causem dano em seus alvos, prejudicando drasticamente os inimigos que estejam com suporte.', 49, 57), 
...
Agora, ocupando um espaço visível na influência política de Schwartzwald, o maior desafio dos Insurgentes será evitar que se tornem aquilo que eles mais combateram no passado.', 50, 58), 
...
Levam consigo o poder oculto do Anjo da Guarda, fiel protetor e guardião.
Apesar de tantas vantagens, Superaprendizes têm as mesmas fragilidades dos Aprendizes.
Ao atingirem o nível de base 99, podem expandir a classe para ganhar novas habilidades e seguir evoluindo', 51,59);